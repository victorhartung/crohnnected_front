...
import { z } from 'zod'
import { Sex, SymptomSeverity, UserRole } from '@prisma/client'
...
export const registerSchema = z.object({
  ...
  role: z.enum(['PATIENT', 'DOCTOR', 'RESEARCHER'] as const).default('PATIENT'),
...
export const patientProfileSchema = z.object({
  ...
  sex: z.enum(['FEMALE', 'MALE', 'INTERSEX', 'OTHER', 'UNSPECIFIED'] as const).optional(),
...
export const reportSchema = z.object({
  ...
  surgeryHistory: z.array(z.object({
    type: z.string(),
