...
export const GET = withAuth(async (request: NextRequest, user: any) => {
  try {
    ...
    // Get recent content
    const [recentArticles, recentProtocols, recentStories] = await Promise.all([
    ...
    recentArticles.forEach(article => {
      recentActivity.push({
        ...
        description: `New article: ${article.title}`,
    ...
    recentProtocols.forEach(protocol => {
      recentActivity.push({
        ...
        type: 'content_created' as const,
        description: `New protocol: ${protocol.title}`,
    ...
    recentStories.forEach(story => {
      recentActivity.push({
        id: `story_${story.id}`,
        type: 'content_created' as const,
        description: `New story: ${story.title}`,
