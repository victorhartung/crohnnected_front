    ...
    <main className="container mx-auto px-4 py-12">
      ...
      <form className="max-w-xl space-y-4">
        <div>
          ...
          <input
            className="mt-1 block w-full rounded-md border px-3 py-2 text-sm bg-header backdrop-blur supports-[backdrop-filter]:bg-white/60"
      ...
      <p className="mt-8 text-sm text-muted-foreground">
        {t("contact.orEmail")}{" "}
        <a href="mailto:contact@crohnnected.com" className="underline">
          {t("contact.emailLink")}
        </a>
        .
      </p>
